...
/oracle/19c/database/bin/sqlplus system/YrrF7Y52NPfZWJxBw7Jh@PREPRODPDB @/usr/local/bin/telegraf/probes/wfm_workflow_statecount.sql | grep workflowstatecount
