...
/oracle/19c/database/bin/sqlplus system/YrrF7Y52NPfZWJxBw7Jh@PREPRODPDB @/usr/local/bin/telegraf/probes/jms_wms_store_queuestatuscount.sql | grep workflowstatuscount
